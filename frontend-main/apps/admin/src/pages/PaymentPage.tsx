...
const PaymentPage = () => {
  ...
  const passengerUser = getLocalStorageValue('passengerUser');
  ...
  const payPayment = async () => {
    ...
    try {
      await API.post(`/admin/booking/checkout-session`, {
        data: { data },
      });
            ...
            <div className="py-5">
              ...
              <div className="pt-6 space-x-2 flex items-center justify-end mx-5">
                <Button
                  type="submit"
                  variant={'link'}
                  className={`bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-bold hover:no-underline hover:cursor-pointer ${
