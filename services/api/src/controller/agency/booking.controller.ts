...
export const Agency_getCheckoutSession = async (
  req: RequestWithUser,
  res: Response,
  next: NextFunction
) => {
...
const Agency_getBooking = async (req: Request, res: Response) => {
...
const Agency_getAllBooking = async (req: Request, res: Response) => {
  try {
...
const Agency_MoveFlightBooking = async (req: Request, res: Response) => {
...
const Agency_deleteBooking = async (req: Request, res: Response) => {
...
const Agency_deleteManyBookings = async (req: Request, res: Response) => {
  const { ids } = req.body;
  try {
...
const Agency_getAllPassengers = async (req: Request, res: Response) => {
  try {
...
const Agency_deleteAllBookings = async (req: Request, res: Response) => {
  try {
...
const Agency_updateBooking = async (
  req: RequestWithUser,
  res: Response,
  next: NextFunction
) => {
...
const Agency_updatePassengerInformation = async (req: Request, res: Response) => {
  const { id } = req.params;
...
const Agency_updateLuggages = async (req: Request, res: Response) => {
  const { id } = req.params;
  const { luggage } = req.body;
  console.log(id, luggage);
  // Validate input
...
const Agency_getAllSeatsByBookingId = async (req: Request, res: Response) => {
  try {
...
const Agency_bookingCheckIn = async (req: Request, res: Response) => {
  const {
    bookingId,
    flightId,
    country,
...
export {
  Agency_getAllBooking,
  Agency_getBooking,
  Agency_MoveFlightBooking,
  Agency_deleteBooking,
  Agency_deleteManyBookings,
  Agency_getAllPassengers,
  Agency_deleteAllBookings,
  Agency_updateBooking,
  Agency_updatePassengerInformation,
  Agency_updateLuggages,
  Agency_getAllSeatsByBookingId,
  Agency_bookingCheckIn
};
