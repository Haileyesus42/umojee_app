...
const PaymentPage = () => {
  ...
  const payPayment = async () => {
    ...
    try {
      const response = await axios.post(
        `${backendUrl}/booking/checkout-session`,
        { data },
        {
          headers: {
  ...
  useEffect(() => {
    if (!user) {
      toast.error('Please login before continue booking!', {
        duration: 6000,
      });
        ...
        <>
          <div className="mx-5 my-5 p-5">
            ...
            <div className="py-5">
              ...
              <div className="sm:grid grid-cols-4 gap-y-5 sm:gap-x-5 my-5 bg-slate-100 dark:bg-slate-500">
                ...
                <div className="sm:ml-4 py-5 flex flex-col justify-between col-span-3">
                  <div className="mx-5">
                    ...
                    <p>{formatTime(selectedFlight.departureTime).date}</p>
                  </div>
                        ...
                        <div className="grid grid-cols-3 py-5 bg-white px-5 dark:bg-slate-400">
                          ...
                          <div className="flex flex-col items-center ">
                            <div>
                              ...
                              <div>{selectedReturnFlight.flightNumber}</div>
                            </div>
                          </div>
                        </div>
                        <div className="mx-5 my-5">
              ...
              <div className="pt-6 space-x-2 flex items-center justify-end mx-5">
                <Button
                  type="submit"
                  variant={'link'}
                  className={`bg-blue-700 text-white text-sm font-bold hover:no-underline hover:cursor-pointer ${loading ? 'cursor-not-allowed' : ''
                    }`}
                  onClick={payPayment}
                  disabled={loading}
                >
