...
import { formatTime, minutesToHoursAndMinutes } from "../../lib/utils";
    ...
    <div>
      {flight && (
        <Modal
          ...
          isHeader={false}
          className="relattive flex z-[101] w-full sm:w-[60%] h-full sm:h-[450px] overflow-auto items-start p-0 text-white"
        >
