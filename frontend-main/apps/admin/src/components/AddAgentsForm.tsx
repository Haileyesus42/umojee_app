...
const AddAgentsForm: React.FC<AgentFormProps> = ({
  defaultValues,
  onSubmit,
  loading,
  onClose,
  ...
  const handleSubmit = async (data: AddAgent) => {
    onSubmit(data);
    form.reset();
  };
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    {activeAgencies.map((agency) => (
                      <SelectItem key={agency._id} value={agency.agencyName}>
                        {agency.agencyName}
                      </SelectItem>
                    ))}
                  </SelectContent>
