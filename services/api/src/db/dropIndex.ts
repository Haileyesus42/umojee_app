...
const mongoUri: string = "mongodb+srv://vipinchaudhary:fNTLn4s17coZlvqT@cluster0.8e1ltns.mongodb.net/?retryWrites=true&w=majority"; // Replace with your actual MongoDB URI
...
async function dropIndex(): Promise<void> {
    ...
    try {
        ...
        const dbName: string = "test"; // Replace with the correct database name
