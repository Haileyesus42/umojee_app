...
export const OTPModal = ({ username }: { username: string }) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      //   navigate(`${url}/auth/resetpassword/${username}/${values.otp}`);
      // }
      otpModal.onClose();
    } catch (error: any) {
  ...
  return (
    <Modal
      title="Verify OTP"
      description="Your code sent to you via phone"
