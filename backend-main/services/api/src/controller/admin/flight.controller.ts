...
const archiveFlight = async (req: Request, res: Response) => {
...
const getAllArchiveFlight = async (req: Request, res: Response) => {
  try {
...
const deleteManyFlights = async (req: Request, res: Response) => {
  const { ids } = req.body;
  console.log("ID", ids)
  try {
...
const cancelFlight = async (req: Request, res: Response) => {
...
const getAllFlightFiltered = async (req: Request, res: Response) => {
