...
const SidebarItem = ({
  ...
  <NavLink
    to={to}
    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium hover:text-white dark:text-white duration-300 ease-in-out hover:bg-emerald-600 dark:hover:bg-meta-4 ${
      isActive
        ? 'bg-emerald-600 dark:bg-meta-4 text-white'
        : 'text-waikawa-gray-900'
    }`}
  >
    {icon}
    {label}
