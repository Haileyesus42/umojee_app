...
import { getAgencies } from '../../store/agencies/agencies-extra';
...
const AgentsPage = () => {
  ...
  const formattedAgents: Agents[] = agentsList.map((item: any) => ({
    ...
    agentsRole: item.agentsRole,
    agentsStatus: item.agentsStatus,
    agentsAgency: item.agentsAgency,
    agencyName: getAgencyNameById(item.agentsAgency, agenciesList),
