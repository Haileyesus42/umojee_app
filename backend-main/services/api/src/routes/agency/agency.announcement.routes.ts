import { CreateAnnouncementTemplate, deleteManyAnnouncemenTemplates, deleteTemplate, getAllAnnouncementTemplates, updateTemplate } from '../../controller/agency/announcements/announcementTemplates.controller';
import express from 'express';
import { Role } from '../../types';
import { deleteAllAnnouncements, deleteAnnouncement, deleteManyAnnouncements, getAllAnnouncements, getAllAnnouncementsByUserId, NewAnnouncement, updateAnnouncement } from '../../controller/agency/announcements/announcement.controller';
