...
import biometricRouter from "./biometric.route";
import emergencyRouter from "./emergency.route";
...
ClientRouter.use("/biometric", biometricRouter);
ClientRouter.use("/emergency", emergencyRouter);
