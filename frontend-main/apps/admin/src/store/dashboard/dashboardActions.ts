...
export const fetchDashboardCardsData = () => {
  return async (dispatch: Dispatch) => {
    try {
      ...
      const res = await axios.get(`${backendUrl}/admin/cards/bookings/getall`, {
        headers: {
  ...
  return async (dispatch: Dispatch) => {
    try {
      ...
      const res = await axios.get(
        `${backendUrl}/admin/cards/flights/monthlystatus/getall/${year}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const fetchPieChartData = () => {
  return async (dispatch: Dispatch) => {
    try {
      const token = cookies.get('token');
      const res = await axios.get(
        `${backendUrl}/admin/cards/flights/status/piechart`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const fetchDashboardAllBookingData = () => {
  return async (dispatch: Dispatch) => {
    try {
      const token = cookies.get('token');
      const res = await axios.get(
        `${backendUrl}/admin/cards/bookings/allbookings`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
...
export const fetchDashboardTodayBookingData = () => {
  return async (dispatch: Dispatch) => {
    try {
      const token = cookies.get('token');
      const res = await axios.get(
        `${backendUrl}/admin/cards/bookings/status/today`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
