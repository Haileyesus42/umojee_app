import { Pencil, Plane, PlaneTakeoff } from 'lucide-react';
              ...
              <div className="flex flex-col justify-between space-y-4">
                ...
                <div className="w-full flex justify-between px-6 space-x-2 sm:space-x-4 md:space-x-6">
                  ...
                  <div className="flex flex-col items-center justify-center hidden sm:block">
                    ...
                    <span className="text-xs">{minutesToHoursAndMinutes(selectedFlight.duration)}</span>
                  </div>
                  <Line className="bg-slate-300 h-px hidden sm:block" />
                  <div className="flex flex-col">
                    <p className="text-xl font-bold w-[95px]">
...
//         flights.map((flight: any) => (
//           <>
//             <div className="flex items-center  lg:grid-cols-5 py-2 px-2 bg-slate-100 shadow-sm rounded-md sm:space-x-2 space-y-3 dark:bg-slate-500">
